...
def ewmaonlineType1(L,mu0,Phi,rho,w,p,CovType,B,Bs,lambda1,allgamma, isewma=False, maxIter = 2, mT2 = 0, sd = 1, initial = 0):
        ...
        for i in range(gammalength):
            if t==0:
                ...
                while iiter < maxIter:
                    ...
                    yhat = H[1]@(y-Snow)@H[2]
                    Yhat = lambdat1*yhat+(1-lambdat1)*thetaold # formula (9)
...
filename = '/home/tgong33/ImageMonitoring/InCtrl/Type1/in/input%d.dat' %index
...
for n in tqdm(range(TstSize)):
    ...
    t =ewmaonlineType1(L,mu0,Phi,rho,w,p,CovType,B,Bs,lambda1,allgamma,maxIter=3,mT2=mT2,sd=sd)
    InControlList.append(t)
    
filename = "/home/tgong33/ImageMonitoring/InCtrl/Type1/out/output%d.npy" %index
